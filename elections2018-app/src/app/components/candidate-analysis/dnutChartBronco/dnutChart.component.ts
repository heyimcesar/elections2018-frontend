...
export class dnutChartBronco implements OnInit, OnDestroy {
  // Doughnut
  ...
  constructor (private dataService: DataService) {
	...
	fillData(data: any) {
		...
		clone[0] = data.politicians[4].politician_nts ;
		clone[1] = data.politicians[4].politician_pts ;
		clone[2] = data.politicians[4].politician_na ;
