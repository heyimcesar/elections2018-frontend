...
fillData(data : any){
  this.doughnutChartData[0] = data.politicians[2].politician_nts ;
  this.doughnutChartData[1] = data.politicians[2].politician_pts ;
  this.doughnutChartData[2] = data.politicians[2].politician_na ;
  ...
  Observable.interval(15000).subscribe(x => {
    ...
    this.dataService.getPolitcianTweets().subscribe(data => {
      this.data = data;
       ...
       clone[1] = data.politicians[2].politician_nts ;
       clone[2] = data.politicians[2].politician_nts ;
